...
import { receivedDocumentsColumns } from "@/section/TableColumnsData/user/sendDocumentColumns";

export function ReceivedDocumentsTable() {
  ...
  const columns = receivedDocumentsColumns({ t, navigate });
          ...
          <div className="flex flex-col justify-between space-y-2 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="text-muted-foreground">
                {t(`Here is the list of all Received Documents.`)}
              </p>
            </div>
          </div>
        </div>
