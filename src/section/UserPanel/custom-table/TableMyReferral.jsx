...
import { myReferralColumns } from "@/section/UserPanel/customTable-columns/myReferral";
import { getMyAllReferrals } from "@/slices/userSlice";
import { useDispatch, useSelector } from "react-redux";

export function TableMyReferral() {
  ...
  const { myReferrals } = useSelector((state) => state.userCustom);

  console.log(myReferrals);
  React.useEffect(() => {
    dispatch(getMyAllReferrals());
  }, [dispatch]);

  const columns = myReferralColumns({ t, navigate });
          ...
          <div className="flex flex-col justify-between space-y-2 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="text-muted-foreground">
                {t(`Here is the list of your all Referrals.`)}
              </p>
            </div>
          </div>
        </div>
