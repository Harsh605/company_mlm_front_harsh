          ...
          <div className="flex w-full flex-col items-center justify-center gap-3">
            <div className="relative">
              <div className="border-primary aspect-square w-[100px] overflow-hidden rounded-full border-4">
                <CustomImage
                  imageUrl={`${userData?.avatar?.url || "/images/profile-pic.jpeg"}`}
                />
              </div>

              <span className="capitalize bg-primary absolute bottom-0  right-2 me-2 rounded-full px-2.5 py-0.5 text-xs font-medium text-background">
                {userData?.role}
              </span>
            </div>
        ...
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <Menu.Button
                          className={classNames(
                            item.id == activeMenuItem
                              ...
                              : "text-foreground hover:bg-background hover:text-gray-600",
            ...
            <li className="mt-auto">
              <Link
                href={`/admin/logs`}
                className="group -mx-2 flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-foreground hover:bg-gray-50 hover:text-gray-600"
              >
