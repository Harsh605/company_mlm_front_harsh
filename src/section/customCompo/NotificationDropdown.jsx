...
const NotificationDropdown = ({
  ...
  // Mimic data fetching using useEffect
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const exampleData = [
        { id: 1, title: "Notification 1", created_at: Date.now() - 60000 },
        { id: 2, title: "Notification 2", created_at: Date.now() - 120000 },
        { id: 3, title: "Notification 3", created_at: Date.now() - 180000 },
      ];
  ...
  return (
    <div className="relative inline-block">
      ...
      {isNotificationOpen && (
        <div
          ref={dropdownRef}
          className="absolute right-0 z-20 mt-2 w-64 origin-top-right overflow-hidden rounded-md bg-white shadow-lg dark:bg-gray-800 sm:w-80"
        >
          <div className="py-2">
